  ...
  return (
    ...
    <div className="flex max-[1189px]:justify-between justify-evenly items-center h-fit w-[100%] p-[2rem_5%] absolute top-4">
      ...
      <div className="max-[1189px]:hidden h-fill bg-[#181918] flex items-center gap-[2.4rem] justify-center p-[1.6rem_2.4rem] text-white rounded-[2.1rem]">
        <Link className="font-zcool text-[2rem] hover:text-red-500" href="/#home">
          Home
        </Link>
        <Link className="font-zcool text-[2rem] hover:text-red-500" href="/#ido">
          IDO
        </Link>
        <Link className="font-zcool text-[2rem] hover:text-red-500" href="/#tokenomics">
          Tokenomics
        </Link>
        <Link className="font-zcool text-[2rem] hover:text-red-500" href="/#roadmap">
          Roadmap
        </Link>
        <Link className="font-zcool text-[2rem] hover:text-red-500" href="/#comingsoon">
          Coming Soon
        </Link>
      </div>
      <WalletConnectNav />
