            ...
            <div className="basis-1/2 flex flex-col items-center">
              ...
              <div className="flex justify-center items-center gap-[1.5rem] w-[95%]">
                <div className="flex justify-between h-[5.5rem] w-[100%] border-[1px] border-[#C4110C] rounded-[20px] ">
                  ...
                  />
                  <button className="h-fill p-[0px_1.5rem] text-[1.5rem] font-zcool m-[2px] bg-samurai-red rounded-[2rem] hover:scale-105 transition-all duration-300">
                    Generate
                  </button>
                </div>
              ...
              <div>
                ...
                <div className="flex flex-col gap-5 border-[#C4110C] border-[2px] items-center justify-center rounded-[20px] p-[8rem] max-[600px]:p-[6rem]">
                  ...
                  <div className="flex gap-[2rem] justify-center mt-[-1rem]">
                    <button className="bg-gradient-to-r from-smurai-grade-red to-smurai-grade-orange rounded-[16.21px] p-[10px_3.5rem] text-[1.408rem] font-zcool mt-[4rem] h-[45px] hover:scale-105 transition-all duration-300">
                      Buy
                    </button>
                    <button className="bg-gradient-to-r from-smurai-grade-red to-smurai-grade-orange rounded-[16.21px] p-[10px_12px] text-[1.408rem] font-zcool mt-[4rem] h-[45px] w-[145px] hover:scale-105 transition-all duration-300">
                      Claim Drop
                    </button>
                  </div>
                </div>
